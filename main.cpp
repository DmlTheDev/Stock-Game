...
int main() {
  ...
  std::string skip;
  std::string sellCost_string;
  std::string buyCost_string;
  int finalChoice;
  int average = 0;
  int displayTip;
  using namespace std;
...
for(int i=0; i < days; i++){
  ...
  if(bors == "1" and dollars != 0){
    ...
    std::cout << "\nIf you want to buy max shares type '12345'\nHow many shares would you like to buy?: ";
    std::cin >> buyCost;
  ...
  //option 2 sold shares
    ...
    std::cout << "\nIf you would like to sell all of your shares type '12345', else...\nHow many shares would you like to sell?: ";
